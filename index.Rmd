...
[Presentation View](https://meggivarnai.github.io/1_rmarkdown_examples/)
...
```{r}
#format data for dygraph to understand. can find in 'help' 
...
**two bolded sections**, and one *italicized phrase*. The content of this paragraph is not vital, but try to at least make it true and interesting, and, of course, don't plagiarize. 
